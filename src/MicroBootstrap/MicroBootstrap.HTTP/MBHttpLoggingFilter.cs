...
namespace MicroBootstrap.HTTP
{
    ...
    internal sealed class MBHttpLoggingFilter : IHttpMessageHandlerBuilderFilter
    {
        ...
        public Action<HttpMessageHandlerBuilder> Configure(Action<HttpMessageHandlerBuilder> next)
        {
            ...
            return builder =>
            {
                ...
                builder.AdditionalHandlers.Insert(0, new MBLoggingScopeHttpMessageHandler(logger, _options));
            };
        }
    }
}